...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (token != null && jwtTokenProvider.validateToken(token)) {
            ...
            // Build authority list — prefix with ROLE_ for Spring Security
            String springRole = role.startsWith("ROLE_") ? role : "ROLE_" + role;
            List<SimpleGrantedAuthority> authorities = List.of(new SimpleGrantedAuthority(springRole));

            // Create a custom principal that carries userId
            ...
            LOG.debug("Authenticated user '{}' (id={}) with role {}", username, userId, springRole);
        }
